...
namespace Transnational_Auto_3
{
    public partial class Invoices : Form
    {
        ...
        private void btnsave_all_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(tableAdapterManager.UpdateOrder.ToString());
        ...
        public void addTotal()
        {
            try
            {
                ...
                int rows = invoice_datagrid.Rows.Count;
                for (int a = 0; a < rows - 1; a++)
                {
                    try
                    {

                        selected_1 = (double)invoice_datagrid.Rows[a].Cells[4].Value;
                        selected_2 = (int)invoice_datagrid.Rows[a].Cells[2].Value;
                    ...
                    invoice_datagrid.Rows[a].Cells[5].Value = selected_total;
        ...
        private void invoice_datagrid_CellBeginEdit(object sender, DataGridViewCellCancelEventArgs e)
        {
            try
            {
                ...
                if (invoice_datagrid.CurrentCell == invoice_datagrid.CurrentRow.Cells[1])
                {
